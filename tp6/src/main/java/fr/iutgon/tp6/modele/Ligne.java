...
public class Ligne {
  private SimpleIntegerProperty qte = new SimpleIntegerProperty();
  ...
  public Ligne(int qte, Produit produit) {
	  ...
	  this.totalHT = Bindings.multiply(
		this.qte,
		Bindings.selectFloat(this.produit, "prix")
	  );
	  this.totalTTC = Bindings.multiply(
		this.totalHT,
		Bindings.selectFloat(this.produit, "tva")
	  );	  
  }
